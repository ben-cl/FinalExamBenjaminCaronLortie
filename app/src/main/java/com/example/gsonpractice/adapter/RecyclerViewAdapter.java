...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private List<DictionaryModel> questionsList;

    //<Store> storeList)
    public RecyclerViewAdapter(Context context,  List<DictionaryModel> storetList) {
        this.context = context;
        this.questionsList = storetList;
    }
...
//    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final DictionaryModel question = questionsList.get(position);

        holder.name.setText(question.getWord());
